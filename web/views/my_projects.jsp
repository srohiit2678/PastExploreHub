<%-- 
    ...
    Created on : 24 Apr, 2025, 10:19:40 AM
    Author     : Rohit
--%>
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <nav class="sidebar">
            ...
            <ul class="menu">
                <li><a href="student.jsp"><i class="fas fa-home"></i> Projects</a></li>
                ...
                <li class="active"><a href="my_projects.jsp"><i class="fas fa-folder-open"></i> My-Projects</a></li>
