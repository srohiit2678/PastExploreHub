...
<% List<Project> projectList = (List<Project>) session.getAttribute("student_projects"); %>
 <%if(projectList==null)
    ...
    <div class="dashboard-container">
        <nav class="sidebar">
            ...
            <ul class="menu">
                ...
                <li class="active"><a href="student_profile.jsp"><i class="fas fa-user"></i> Profile</a></li>
